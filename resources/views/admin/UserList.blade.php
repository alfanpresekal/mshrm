...
<html>
  <head>
    ...
    <title>2016 mshrm ⋅ User List</title>
    ...
    <div class="wrapper">
            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  ...
                  <span class="hidden-xs">Taufiq Bahruddin</span>
                </a>
                <ul class="dropdown-menu">
                  <!-- User image -->
                  <li class="user-header">
                    <img src="{{ asset('/LTEAdmin/dist/img/user2-160x160.jpg') }}" class="img-circle" alt="User Image">
                    <p>
                      Taufiq Bahruddin - Software Developer
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="{{ url('/system/UserRegister') }}"><i class="fa fa-user-plus"></i> User Registrar</a></li>
                <li><a href="{{ url('/admin/UserList') }}"><i class="fa fa-user"></i> User List</a></li>
              </ul>
            </li>
          </ul>
        </section>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            User Registrar
            <small>Lakukan registrasi user.</small>
          </h1>
          <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Users</a></li>
            <li class="active">User Registrar</li>
          </ol>
        </section>
		...
		<div class="box box-info">
		  <div class="box-header with-border">
			<h3 class="box-title">User Registrar</h3>
